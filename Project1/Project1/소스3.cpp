...
void main(void) {
	...
	element data;
	printf("\n ****** 원형 큐 연산 ****** \n");
	printf("\n 삼입 A>>"); enQueue(cQ, 'A'); printQ(cQ);
	printf("\n 삼입 B>>"); enQueue(cQ, 'B'); printQ(cQ);
	printf("\n 삼입 C>>"); enQueue(cQ, 'C'); printQ(cQ);
	...
	printf("\n 삭제 >>"); data = deQueue(cQ); printQ(cQ);
	printf("\t\t삭제 데이터 : %c", data);
	printf("\n 삼입 D>>"); enQueue(cQ, 'D'); printQ(cQ);
	printf("\n 삼입 E>>"); enQueue(cQ, 'E'); printQ(cQ);
	getchar();
}